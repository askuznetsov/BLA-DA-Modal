...
class NeuralModel:
    def __init__(self):
        ...
        self.DrF = 0.75  # Baseline drive for F neurons
        self.DrS = 0.75  # Baseline drive for S neurons
        ...
        self.ExIS = 2          # was 3 Excitation of IS neurons
        ...
        self.ExIF = 2          # was 3 Excitation of IF neurons
    ...
    def plot_results(self, t, F, S, IS, IF):
        ...
        plt.xlim(0, 2000)
        plt.ylim(0, 1)
        plt.text(500, 0.2, 'Low DA', va='bottom', ha='center', rotation=0)
        plt.text(1500, 0.2, 'High DA', va='bottom', ha='center', rotation=0)
