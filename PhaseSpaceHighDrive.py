...
# Define parameters
DrF = 0.75 # defines the max and min activation of the F neurons, but not the transition
DrS = 0.75 # was 0.5
...
lp = 0.16
arrow2=plt.arrow(0.03, lp, 0.01, 0, head_width=0.03, head_length=0.06, color='black')
